...
public class off_4harf extends AppCompatActivity {

    private ImageView b_back, b_again;
    private EditText[] editTexts1, editTexts2, editTexts3, editTexts4;
    private CardView [] cardViews1, cardViews2, cardViews3, cardViews4;
    int currentEditTextIndex1 = 0,currentEditTextIndex2 = 0,currentEditTextIndex3 = 0,currentEditTextIndex4 = 0, denemeHakki;
    private String[] kelimeler = {"AĞRI", "BOLU", "İÇEL", "KARS", "ORDU", "RİZE", "UŞAK"};
    private String secilenKelime, secilenKelime1,secilenKelime2,secilenKelime3,secilenKelime4, olusanKelime1, olusanKelime2, olusanKelime3, olusanKelime4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_off4harf );
    ...
    private void sureyiBaslat60() {
        countDownTimer = new CountDownTimer(oyunSure, 1000) {
            ...
            public void onFinish() {
                Toast.makeText( off_4harf.this, "60 SANİYEDİR OYNAMADINIZ", Toast.LENGTH_SHORT ).show();
                vb.vibrate( 500 );
                sureyiBaslat10();
        ...
        kb_entr.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (denemeHakki == 1){
                    ...
                    if (currentEditTextIndex4 < editTexts4.length){
                        ...
                        kelimeListesindeVarMi = false;
                        for (String kelime : kelimeler) {
                            if (kelime.equalsIgnoreCase(olusanKelime4)) {
                                kelimeListesindeVarMi = true;
                                break;
                            }
                        }
