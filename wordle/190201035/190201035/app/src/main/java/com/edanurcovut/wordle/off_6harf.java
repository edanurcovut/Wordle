...
public class off_6harf extends AppCompatActivity {

    private ImageView b_back, b_again;
    private EditText[] editTexts1, editTexts2, editTexts3, editTexts4, editTexts5, editTexts6;
    private CardView [] cardViews1, cardViews2, cardViews3, cardViews4, cardViews5, cardViews6;
    int currentEditTextIndex1 = 0,currentEditTextIndex2 = 0,currentEditTextIndex3 = 0,currentEditTextIndex4 = 0,currentEditTextIndex5 = 0,currentEditTextIndex6 = 0, denemeHakki;
    private String[] kelimeler = { "ANKARA", "AMASYA", "ARTVİN", "BATMAN", "BİNGÖL", "BİTLİS", "BURDUR", "EDİRNE", "ELAZIĞ", "MANİSA", "MARDİN", "SAMSUN", "ŞIRNAK", "YALOVA", "YOZGAT" };
    private String secilenKelime, secilenKelime1,secilenKelime2,secilenKelime3,secilenKelime4,secilenKelime5,secilenKelime6,
            olusanKelime1, olusanKelime2, olusanKelime3, olusanKelime4, olusanKelime5, olusanKelime6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_off6harf );
        ...
        kb_entr.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (denemeHakki == 1){
                    ...
                    if (currentEditTextIndex6 < editTexts6.length){
                        ...
                        kelimeListesindeVarMi = false;
                        for (String kelime : kelimeler) {
                            if (kelime.equalsIgnoreCase(olusanKelime6)) {
                                kelimeListesindeVarMi = true;
                                break;
                            }
                        }
