...
public class off_7harf extends AppCompatActivity {

    private ImageView b_back, b_again;
    private EditText[] editTexts1, editTexts2, editTexts3, editTexts4, editTexts5, editTexts6, editTexts7;
    private CardView [] cardViews1, cardViews2, cardViews3, cardViews4, cardViews5, cardViews6, cardViews7;
    int currentEditTextIndex1 = 0,currentEditTextIndex2 = 0,currentEditTextIndex3 = 0,currentEditTextIndex4 = 0,
            currentEditTextIndex5 = 0,currentEditTextIndex6 = 0, currentEditTextIndex7 = 0,denemeHakki;
    private String[] kelimeler = { "AKSARAY", "ANTALYA", "ARDAHAN", "BAYBURT", "BİLECİK", "ÇANKIRI", "DENİZLİ", "ERZURUM", "GİRESUN", "HAKKARİ", "ISPARTA", "KARABÜK", "KARAMAN", "MALATYA", "SAKARYA" };
    private String secilenKelime, secilenKelime1,secilenKelime2,secilenKelime3,secilenKelime4,secilenKelime5,secilenKelime6, secilenKelime7,
            olusanKelime1, olusanKelime2, olusanKelime3, olusanKelime4, olusanKelime5, olusanKelime6, olusanKelime7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_off7harf );
        ...
        secilenKelime6 = secilenKelime;
        secilenKelime7 = secilenKelime;
    ...
    public void KlavyeTanimlamalari(){
    ...
    private void EdittextTanimlamalari(){
        editTexts1 = new EditText[]{
                ...
                findViewById( R.id.ed_harf16 ),
                findViewById( R.id.ed_harf17 )
        ...
        editTexts2 = new EditText[]{
                ...
                findViewById(R.id.ed_harf26),
                findViewById(R.id.ed_harf27)
        };
        ...
        editTexts3 = new EditText[]{
                ...
                findViewById(R.id.ed_harf36),
                findViewById(R.id.ed_harf37)
        };
        ...
        editTexts4 = new EditText[]{
                ...
                findViewById(R.id.ed_harf46),
                findViewById(R.id.ed_harf47)
        };
        ...
        editTexts5 = new EditText[]{
                ...
                findViewById(R.id.ed_harf56),
                findViewById(R.id.ed_harf57)
        };

        editTexts6 = new EditText[]{

                findViewById(R.id.ed_harf61),
                findViewById(R.id.ed_harf62),
                findViewById(R.id.ed_harf63),
                findViewById(R.id.ed_harf64),
                findViewById(R.id.ed_harf65),
                findViewById(R.id.ed_harf66),
                findViewById(R.id.ed_harf67)
        };

        editTexts7 = new EditText[]{

                findViewById(R.id.ed_harf71),
                findViewById(R.id.ed_harf72),
                findViewById(R.id.ed_harf73),
                findViewById(R.id.ed_harf74),
                findViewById(R.id.ed_harf75),
                findViewById(R.id.ed_harf76),
                findViewById(R.id.ed_harf77)
        };
    ...
    private void CardViewTanimlamalari(){
        cardViews1 = new CardView[]{
                ...
                findViewById( R.id.cv_harf16 ),
                findViewById( R.id.cv_harf17 )
        ...
        cardViews2 = new CardView[]{
                ...
                findViewById( R.id.cv_harf26 ),
                findViewById( R.id.cv_harf27 )
        ...
        cardViews3 = new CardView[]{
                ...
                findViewById( R.id.cv_harf36 ),
                findViewById( R.id.cv_harf37 )
        ...
        cardViews4 = new CardView[]{
                ...
                findViewById( R.id.cv_harf46 ),
                findViewById( R.id.cv_harf47 )
        ...
        cardViews5 = new CardView[]{
                ...
                findViewById( R.id.cv_harf56 ),
                findViewById( R.id.cv_harf57 )

        };

        cardViews6 = new CardView[]{

                findViewById( R.id.cv_harf61 ),
                findViewById( R.id.cv_harf62 ),
                findViewById( R.id.cv_harf63 ),
                findViewById( R.id.cv_harf64 ),
                findViewById( R.id.cv_harf65 ),
                findViewById( R.id.cv_harf66 ),
                findViewById( R.id.cv_harf67 )

        };

        cardViews7 = new CardView[]{

                findViewById( R.id.cv_harf71 ),
                findViewById( R.id.cv_harf72 ),
                findViewById( R.id.cv_harf73 ),
                findViewById( R.id.cv_harf74 ),
                findViewById( R.id.cv_harf75 ),
                findViewById( R.id.cv_harf76 ),
                findViewById( R.id.cv_harf77 )
    ...
    private void Keyboard(){
        ...
        kb_e.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else  if (denemeHakki == 6){
                    for (int i = currentEditTextIndex6; i < editTexts6.length; i++) {
                        EditText currentEditText = editTexts6[i];
                        if (currentEditText.getText().toString().isEmpty()) {
                            currentEditText.setText("E");
                            currentEditTextIndex6 = i + 1; // Sonraki EditText'e geçmek için indeksi güncelle
                            break;
                        } else if (i == editTexts6.length - 1) {
                        }
                    }
                }

                else  if (denemeHakki == 7){
                    for (int i = currentEditTextIndex7; i < editTexts7.length; i++) {
                        EditText currentEditText = editTexts7[i];
                        if (currentEditText.getText().toString().isEmpty()) {
                            currentEditText.setText("E");
                            currentEditTextIndex7 = i + 1; // Sonraki EditText'e geçmek için indeksi güncelle
                            break;
                        } else if (i == editTexts7.length - 1) {
                        }
                    }
                }
        ...
        kb_del.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (denemeHakki == 1){
                    ...
                    if (currentEditTextIndex6 > 0) {
                        currentEditTextIndex6--;
                        // Şu anki EditText'i al
                        EditText currentEditText = editTexts6[currentEditTextIndex6];
                        // EditText'teki metni temizle
                        currentEditText.setText("");
                    }
                    else {
                        currentEditTextIndex6 = 0;
                    }
                }

                else if (denemeHakki == 7){
                    if (currentEditTextIndex7 > 0) {
                        currentEditTextIndex7--;
                        // Şu anki EditText'i al
                        EditText currentEditText = editTexts7[currentEditTextIndex7];
                        // EditText'teki metni temizle
                        currentEditText.setText("");
                    }
                    else {
                        currentEditTextIndex7 = 0;
                    }
                }
        ...
        kb_entr.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (denemeHakki == 1){
                    ...
                    if (currentEditTextIndex5 < editTexts5.length){ //BOŞ KUTU KONTROLÜ
                        ...
                        //BU KISIM KELİMENİN BİİM LİSTEMİZDE VAR OLUP OLMADIĞININ KONTROLÜNÜ SAĞLAR
                        for (String kelime : kelimeler) {
                            if (kelime.equalsIgnoreCase(olusanKelime5)) {//BÜYÜK KÜÇÜK HARF DUYARLILIĞI
                                kelimeListesindeVarMi = true;
                                break;
                            }
                        }
                    ...
                    if (currentEditTextIndex6 < editTexts6.length){ //BOŞ KUTU KONTROLÜ
                        ...
                        for (int i = 0; i < editTexts6.length; i++) {
                            kelimeBuilder.append(editTexts6[i].getText().toString().trim());
                        }

                        olusanKelime6 = kelimeBuilder.toString();
                        kelimeBuilder.setLength(0);
                        ...
                        //BU KISIM KELİMENİN BİİM LİSTEMİZDE VAR OLUP OLMADIĞININ KONTROLÜNÜ SAĞLAR
                        for (String kelime : kelimeler) {
                            if (kelime.equalsIgnoreCase(olusanKelime6)) {//BÜYÜK KÜÇÜK HARF DUYARLILIĞI
                                kelimeListesindeVarMi = true;
                                break;
                            }
                        }
                        ...
                        if (kelimeListesindeVarMi) {
                            ...
                            if (olusanKelime6.equals( secilenKelime6 )){
                            ...
                            else
                            {
                                ...
                                // EŞLEŞEN VE EŞLEŞMEYEN HARFLERİ TUTACAK DİZİ
                                int[] eslesenIndexler6 = new int[secilenKelime6.length()];
                                int[] eslesmeyenIndexler6 = new int[secilenKelime6.length()];

                                // HARFLERİ KARŞILAŞTIR VE DİZİYE GÖNDER
                                for (int i = 0; i < secilenKelime6.length(); i++) {
                                    if (secilenKelime6.charAt(i) == olusanKelime6.charAt(i)) {
                                        eslesenIndexler6[i] = 1;
                                        cardViews6[i].setCardBackgroundColor(getResources().getColor(android.R.color.holo_green_dark));
                                    }

                                    else {
                                        eslesmeyenIndexler6[i] = 1;
                                        cardViews6[i].setCardBackgroundColor(getResources().getColor(android.R.color.black));
                                    }
                                }

                                // EŞLEŞMEYEN INDEXLERLE İLGİLİ İŞLEMLER
                                for (int i = 0; i < secilenKelime6.length(); i++) {
                                    if (eslesmeyenIndexler6[i] == 1) { // EŞLEŞMEYEN INDEX
                                        for (int j = 0; j < secilenKelime6.length(); j++) {
                                            if (olusanKelime6.charAt(i) == secilenKelime6.charAt(j) && eslesenIndexler6[j] == 0) {
                                                eslesenIndexler6[j] = 1;
                                                cardViews6[i].setCardBackgroundColor(getResources().getColor(android.R.color.holo_orange_dark));
                                                break; // EŞLEŞME VARSA TURUNCU OLUR VE DÖNGÜ SONA ERER
                                            }
                                        }
                                    }
                    ...
                    if (currentEditTextIndex7 < editTexts7.length){
                        //Kelime Tamamlanmadıysa
                    } else {

                        for (int i = 0; i < editTexts7.length; i++) {
                            kelimeBuilder.append(editTexts7[i].getText().toString().trim());
                        }

                        olusanKelime7 = kelimeBuilder.toString();
                        kelimeBuilder.setLength(0);

                        // Oluşan kelimenin kelime listesinde olup olmadığını kontrol et
                        kelimeListesindeVarMi = false;
                        for (String kelime : kelimeler) {
                            if (kelime.equalsIgnoreCase(olusanKelime7)) {
                                kelimeListesindeVarMi = true;
                                break;
                            }
                        }
                        ...
                        if (kelimeListesindeVarMi) {
                            if (olusanKelime7.equals( secilenKelime7 )){
                                OyunBitirmek();
                                //OYUNCUNUN YAZDIĞI KELİME OYUNUN RASTGELE VERDİĞİ KELİME İLE AYNIYSA
                                OyunBitirmek();
                                oyunSonucu = 1;
                            ...
                            else
                            {
                                ...
                                // EŞLEŞEN VE EŞLEŞMEYEN HARFLERİ TUTACAK DİZİ
                                int[] eslesenIndexler7 = new int[secilenKelime7.length()];
                                int[] eslesmeyenIndexler7 = new int[secilenKelime7.length()];

                                // HARFLERİ KARŞILAŞTIR VE DİZİYE GÖNDER
                                for (int i = 0; i < secilenKelime7.length(); i++) {
                                    if (secilenKelime7.charAt(i) == olusanKelime7.charAt(i)) {
                                        eslesenIndexler7[i] = 1;
                                        cardViews7[i].setCardBackgroundColor(getResources().getColor(android.R.color.holo_green_dark));
                                        ...
                                        eslesmeyenIndexler7[i] = 1;
                                        cardViews7[i].setCardBackgroundColor(getResources().getColor(android.R.color.black));
                                    }
                                }

                                // EŞLEŞMEYEN INDEXLERLE İLGİLİ İŞLEMLER
                                for (int i = 0; i < secilenKelime7.length(); i++) {
                                    if (eslesmeyenIndexler7[i] == 1) { // EŞLEŞMEYEN INDEX
                                        for (int j = 0; j < secilenKelime7.length(); j++) {
                                            if (olusanKelime7.charAt(i) == secilenKelime7.charAt(j) && eslesenIndexler7[j] == 0) {
                                                eslesenIndexler7[j] = 1;
                                                cardViews7[i].setCardBackgroundColor(getResources().getColor(android.R.color.holo_orange_dark));
